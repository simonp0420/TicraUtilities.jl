...
# example was generated by the Ticra GRASP program from the same measured cut file. The maximum difference between
# the spherical wave "Q" coefficients in `sph_julia` and `sph_grasp` is
